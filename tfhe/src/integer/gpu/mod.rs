...
/// - [CudaStreams::synchronize] __must__ be called after this function as soon as synchronization
///   is required
pub unsafe fn unchecked_compression_compress_integer_radix_async<T: UnsignedInteger>(
    streams: &CudaStreams,
    ...
    scratch_cuda_compression_integer_radix_ciphertext_64(
        ...
        lwe_per_glwe,
        storage_log_modulus,
        CompressionType::Compress as u32,
        true,
    );

    cuda_compression_compress_integer_radix_ciphertext_64(
        streams.ptr.as_ptr(),
        streams.gpu_indexes.as_ptr(),
        streams.len() as u32,
    ...
    cleanup_cuda_compression_integer_radix_ciphertext_64(
        streams.ptr.as_ptr(),
        streams.gpu_indexes.as_ptr(),
        streams.len() as u32,
        std::ptr::addr_of_mut!(mem_ptr),
...
/// - [CudaStreams::synchronize] __must__ be called after this function as soon as synchronization
///   is required
pub unsafe fn unchecked_compression_decompress_integer_radix_async<
    T: UnsignedInteger,
    B: Numeric,
>(
    streams: &CudaStreams,
    ...
    scratch_cuda_compression_integer_radix_ciphertext_64(
        ...
        lwe_per_glwe,
        storage_log_modulus,
        CompressionType::Decompress as u32,
        true,
    );

    cuda_compression_decompress_integer_radix_ciphertext_64(
        streams.ptr.as_ptr(),
        streams.gpu_indexes.as_ptr(),
        streams.len() as u32,
        lwe_out.as_mut_c_ptr(0),
